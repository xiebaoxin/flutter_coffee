...
class GoodsItem extends StatelessWidget {
  ...
  GoodsItem(this.item, {this.type = 0});

  @override
  Widget build(BuildContext context) {
    if (type == 1)
      return buildtype1(context);
    else
      return buildtype0(context);
  }

  Widget buildtype0(BuildContext context) {
    return Container(
...
//          Application.goodsDetail(context, item['goods_id'].toString());
  ...
  Widget buildtype1(BuildContext context) {
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  Text(
                    ...
                    '获得：${((double.tryParse(item['shop_price']) ?? 0) * (double.tryParse(item['jtrate']) ?? 0)).toStringAsFixed(4)}TML':
